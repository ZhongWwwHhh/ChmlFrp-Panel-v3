            ...
            >
                ...
                <n-tab-pane name="Cravatar" tab="Cravatar">
                    ...
                    <n-button
                        ...
                        block
                        :loading="loadingUpdateImg"
                        @click="resetUserImg(CravatarImg)"
                        secondary
                        strong
                        style="margin-top: 16px"
                    >
...
const resetUserImg = async (userImg: string) => {
    ...
    try {
        const response = await api.v2.user.updateUserImage(userInfo?.usertoken || '', userImg);
...
const resetQQ = async () => {
    ...
    try {
        const response = await api.v2.user.updateQQ(userInfo?.usertoken || '', newQQ.value);
...
const resetUserName = async () => {
    ...
    try {
        const response = await api.v2.user.updateUserName(userInfo?.usertoken || '', newUserName.value);
