    ...
    <n-card title="统计信息">
        <template #header-extra>
            <n-switch v-model:value="available" @change="onSwitchChange">
                <template #checked> 可用性 </template>
                <template #unchecked> 状 态 </template>
            </n-switch>
        </template>
            ...
            <n-card size="small" hoverable @click="goToNodeInfo(nodeStatusCard.node_name)">
                ...
                <template #header-extra>
                    <n-flex>
                        ...
                        <n-tag round :bordered="false" v-if="nodeStatusCard.state === 'offline'"> 离线 </n-tag>
                    </n-flex>
                </template>
                <n-flex justify="space-around" size="large" align="center">
                    <n-progress
                        type="circle"
                        :percentage="nodeStatusCard.bandwidth_usage_percent"
        ...
        <n-grid-item v-for="(node, index) in processedUptimeData" :key="index">
            <n-card hoverable @click="goToNodeInfo(node.node_name)">
                <ServiceUptime
                    ...
                    :state="node.state"
                    :uptimeHistory="node.uptimeHistory"
                    :group="node.group"
